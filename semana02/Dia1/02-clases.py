...
#Una clase es como una plantilla que va a ser para empezar a definir los atributos
# y metodos de ese determinado objeto
class Persona:
    #atributos
    estatura = 100
    colorOjos = "Cafe"
...
# CONSTRUCTOR
# self > es la referencia de la instancia que hemos creado en relacion a su posicion de memoria, con
# esto no modificaremos a las demas instancias cuando cambiemos algun atributo o comportamiento de una instancia
...
mascotaPerro = Mascota("Morocha","Perro","Salchicha","Hembra")
mascotaGato = Mascota("Michifus","Gato","Siames","Macho")
